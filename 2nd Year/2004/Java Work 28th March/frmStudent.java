...
//****************************************************************************************************
  ...
  private void jbInit() throws Exception
  {
    ...
    this.setSize(new Dimension(385, 350));
	...
	{//Delete Data
		...
		try
		{
			...
			else
			{
				...
				yn = JOptionPane.showConfirmDialog(null,"Are you sure you want to DELETE record "+n+" ?","Conformation...",JOptionPane.YES_NO_OPTION,3);
