...
{//Class
	...
	{//Constructor
    	...
    	try
		{
			...
			//Specifying DNS
			Connection cn = DriverManager.getConnection("jdbc:odbc:Oracle_DSN","adeel","malik"); //DriverManager is a class in SQL package and getConnection method of class DriverManager
