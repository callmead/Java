...
public class frmSupplier extends JFrame
{
	...
	JPanel pnlTable=new JPanel();
			...
			JTable table1;
			String [] columnHead={"Supplier No","Name","Address","Phone","Mobile"};
			String [][] rowData={
	...
	public frmSupplier()
	{
		...
		lblAddress.setBackground(Color.blue);
		...
		lblPhone.setBackground(Color.blue);
		...
		lblMobile.setBackground(Color.blue);
...
{
	frmSupplier mem=new frmSupplier();
	mem.setVisible(true);
}
}// End of Class