...
// ================ supper class================
  ...
  */
  ...
  private void jbInit() throws Exception {
    ...
    this.setSize(new Dimension(390, 330));
    this.setFrameIcon(new ImageIcon("I.jpg"));
  ...
  public void clearFields()
  {
   ...
   public void delData()
    {
		    ResultSet rsdel;
            String tempID = JOptionPane.showInputDialog(null,"Enter Student ID");
            String srch = "SELECT * From Tution WHERE SID="+"'"+tempID+"'";
  			String s = "Delete From Tution WHERE SID="+"'"+tempID+"'";

  	        System.out.println(s);
			try {            //=========ConfirmDialog Box================

				  rsdel=db.stmt.executeQuery(srch);
				  if (rsdel.next())
				  {
				  ...
				  else
				  {
					  ...
					  JOptionPane.showMessageDialog(null,"Sorry, Matching Record Not Found !!!");
