...
*/
  ...
  public frmReport(String s,String q) {
	  Head = s;
	  SQL=q;
    try {
      jbInit();
...
/*
  public static void main(String[] args) {
    frmReport frmReport = new frmReport("My Data Report","Select * from student");
...
*/
  ...
  private void jbInit() throws Exception {
    ...
    //==============Defind the Table==============
    //getTableData("Select * from student");
    getTableData(SQL);
  ...
  void getTableData(String SQLString)
  {
	  ...
	  try{
		  ...
		  if (!rs.next()) {
			  JOptionPane.showMessageDialog(null,"Sorry no more record's fund !!!");
			  return;
		  }//End of if
		  //==================Declear Result setMeta Data=======
		  ResultSetMetaData rsmd = rs.getMetaData();
		  //===============get Culom Data=====================
		  for(int j=1; j<=rsmd.getColumnCount(); ++j) ColumHead.addElement(rsmd.getColumnName(j));
		  ...
		  }while(rs.next());//End of do-while loop
	  }catch(SQLException sqle){System.out.println("Set Row data Error !");}
  }//End of Method
