...
//Define User's Methods...
	...
	{//Display Data
		...
		//MySQL Data format is yyyy-mm-dd SimpleDateFormat doesnt work
		...
		try
		{
			...
			txtDOB.setText(sdf.format(rsStu.getDate(5)));
			//txtDOB.setText(rsStu.getString(5));
	...
	{//Save Data
		try
		{
			...
			//Setting Date Format for BackEnd...
			SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
			String newDate = sdf.format(txtDOB.getText());
