...
{//Class
	...
	{//userValidate()
		...
		//if(user.equals("Admin"))//Case SEnsitive
		//if(user.equalsIgnoreCase("Admin"))//As username is not case sensitive so we can give this command
		...
		if(!user.equalsIgnoreCase(UName) && pass.equals(Pword))//Username is not case sensitive but password is casesensitive
		{
			System.out.println("Sorry, Invalid User!!!");
			txtUser.requestFocus();
			txtUser.selectAll();
		}
		else if(user.equalsIgnoreCase(UName) || !pass.equals(Pword))
		{
