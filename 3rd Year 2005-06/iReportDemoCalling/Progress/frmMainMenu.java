  ...
  private void jbInit() throws Exception {
    ...
    mnuReportSupp.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
			    ...
			    QBDialog rptDlg = new QBDialog("SELECT supply.* FROM supply",
			                                   "./Reports/SuppDetails.rpt",
			                                   "./Data/SIS.mdb",
			                                   "","",1); //1- Access
			                                   
			                                   
			    rptDlg.setVisible(true);
      }
    });
    ...
    new Utils().loadBackgroundImage(this,jDesktopPane1,"Images/Imran.jpg",600,500);
    this.getContentPane().add(new JStatusBar(),BorderLayout.SOUTH);
    new Utils().setLookup(2,this);
    new Utils().setFrameImage(this,"Images/Imran.jpg",32,32);
