...
public final class PdfReader {
	...
	*/
	protected static final Pattern _patObjIntro = Pattern.compile(
		PdfReader.REGEX_WHITESPACE + "*\\d+" + PdfReader.REGEX_WHITESPACE + "+\\d+" +
		PdfReader.REGEX_WHITESPACE + "+obj" + PdfReader.REGEX_WHITESPACE + "+");
	...
	*/
	protected static final Pattern _patStartxref = Pattern.compile(PdfReader.REGEX_EOL +
								       "startxref" + PdfReader.REGEX_EOL + "\\d+" +
								       PdfReader.REGEX_WHITESPACE);
	...
	*/
	protected static final Pattern _patXrefTable = Pattern.compile("xref" + PdfReader.REGEX_EOL +
								       "[^t]*" +
								       "trailer" + PdfReader.REGEX_EOL);
