...
public class frmMainMenu extends JFrame {
  ...
  private void jbInit() throws Exception {
    ...
    new Utils().loadBackgroundImage(this,jDesktopPane1,"Images/Crystal.jpg",1024,768);
    this.getContentPane().add(new JStatusBar(),BorderLayout.SOUTH);
    new Utils().setLookup(2,this); //Value 0 Default, 1 Motif, 2 Windows
    new Utils().setFrameImage(this,"Images/Crystal.jpg",32,32);
  }
}