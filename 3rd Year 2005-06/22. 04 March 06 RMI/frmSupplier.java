...
public class frmSupplier extends JFrame
{
  ...
  JDate pnlDate = new JDate();
   ...
   private void jbInit() throws Exception {
       ...
       //suppcon = (SupplierController)Naming.lookup("rmi://localhost/SupplierController");
       //suppcon = (SupplierController)Naming.lookup("rmi://192.168.1.254/SupplierController");
...
//=========================================================================
	...
	public void OnBtnFind()
	{
		try{
			 Search();
		}catch(RemoteException re){System.out.println("data Find Error :"+re);}
	}//End of Find Method
    ...
    /**************************************************************
    Function : This Method Search a Specific Data
    Return   : none
    **************************************************************/

    public void Search() throws RemoteException
    {
        frmSearchData frmSearchData = new frmSearchData("Supplier");
        frmSearchData.setVisible(true);

    	String srchStr= frmSearchData.sqlString;

        try{
        if (suppcon.isFound(srchStr))
		{
            supp = suppcon.SearchData(srchStr);
            display();
	    }
	    else
	    {
			   JOptionPane.showMessageDialog(null,
                ...
                System.out.println("data Find Error :"+re);
                }
		         ...
		         if (suppcon.isFound(srchStr))
		 		 {
    	             ...
    	             String strQuery="Delete From Supplier " + srchStr;
